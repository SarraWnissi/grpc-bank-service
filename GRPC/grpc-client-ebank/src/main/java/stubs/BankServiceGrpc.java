...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<stubs.Ebank.ConvertCurrencyRequest,
      stubs.Ebank.ConvertCurrencyResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "convert",
      requestType = stubs.Ebank.ConvertCurrencyRequest.class,
      responseType = stubs.Ebank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<stubs.Ebank.ConvertCurrencyRequest,
      stubs.Ebank.ConvertCurrencyResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<stubs.Ebank.ConvertCurrencyRequest, stubs.Ebank.ConvertCurrencyResponse> getConvertMethod;
    if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
          BankServiceGrpc.getConvertMethod = getConvertMethod = 
              io.grpc.MethodDescriptor.<stubs.Ebank.ConvertCurrencyRequest, stubs.Ebank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BankService", "convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stubs.Ebank.ConvertCurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stubs.Ebank.ConvertCurrencyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<stubs.Ebank.ConvertCurrencyRequest,
      stubs.Ebank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<stubs.Ebank.ConvertCurrencyRequest,
      stubs.Ebank.ConvertCurrencyResponse> getPerformStreamMethod() {
    io.grpc.MethodDescriptor<stubs.Ebank.ConvertCurrencyRequest, stubs.Ebank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<stubs.Ebank.ConvertCurrencyRequest,
      stubs.Ebank.ConvertCurrencyResponse> getGetStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<stubs.Ebank.ConvertCurrencyRequest,
      stubs.Ebank.ConvertCurrencyResponse> getGetStreamMethod() {
    io.grpc.MethodDescriptor<stubs.Ebank.ConvertCurrencyRequest, stubs.Ebank.ConvertCurrencyResponse> getGetStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<stubs.Ebank.ConvertCurrencyRequest,
      stubs.Ebank.ConvertCurrencyResponse> getFullStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<stubs.Ebank.ConvertCurrencyRequest,
      stubs.Ebank.ConvertCurrencyResponse> getFullStreamMethod() {
    io.grpc.MethodDescriptor<stubs.Ebank.ConvertCurrencyRequest, stubs.Ebank.ConvertCurrencyResponse> getFullStreamMethod;
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void convert(stubs.Ebank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<stubs.Ebank.ConvertCurrencyResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getConvertMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<stubs.Ebank.ConvertCurrencyRequest> performStream(
        io.grpc.stub.StreamObserver<stubs.Ebank.ConvertCurrencyResponse> responseObserver) {
    ...
    /**
     */
    public void getStream(stubs.Ebank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<stubs.Ebank.ConvertCurrencyResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<stubs.Ebank.ConvertCurrencyRequest> fullStream(
        io.grpc.stub.StreamObserver<stubs.Ebank.ConvertCurrencyResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                stubs.Ebank.ConvertCurrencyRequest,
                stubs.Ebank.ConvertCurrencyResponse>(
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractStub<BankServiceBlockingStub> {
    ...
    /**
     */
    public stubs.Ebank.ConvertCurrencyResponse convert(stubs.Ebank.ConvertCurrencyRequest request) {
    ...
    /**
     */
    public java.util.Iterator<stubs.Ebank.ConvertCurrencyResponse> getStream(
        stubs.Ebank.ConvertCurrencyRequest request) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractStub<BankServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<stubs.Ebank.ConvertCurrencyResponse> convert(
        stubs.Ebank.ConvertCurrencyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((stubs.Ebank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<stubs.Ebank.ConvertCurrencyResponse>) responseObserver);
          break;
        case METHODID_GET_STREAM:
          serviceImpl.getStream((stubs.Ebank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<stubs.Ebank.ConvertCurrencyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return stubs.Ebank.getDescriptor();
    }
